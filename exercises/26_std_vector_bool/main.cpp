...
int main(int argc, char **argv) {
    ...
    constexpr auto expected_vector_bool_size = 24u;
#elif defined(__GLIBCXX__)
    constexpr auto expected_vector_bool_size = 40u;
#else
    constexpr auto expected_vector_bool_size = sizeof(std::vector<bool>);
#endif
    ASSERT(sizeof(vec) == expected_vector_bool_size, "Fill in the correct value.");
    {
        vec[20] = false;
